...
"#;
    ...
    let actual_str = actual.to_string();
    //TODO: Workaround for generated variable names in query.. perhaps rename them..
    let expected_query_str = r#"SELECT ?valve_path_name ?valve__Dash___Mvm___Period___stVal__path_name ?valve_PosPct___Period___mag__path_name ?valve__Dash___Mvm___Period___stVal__timeseries_datapoint_value ?valve_PosPct___Period___mag__timeseries_datapoint_value ?timestamp WHERE { {SELECT (<https://github.com/magbak/quarry-rs#nestAggregation>(?valve__Dash___Mvm___Period___stVal__path_name) AS ?valve__Dash___Mvm___Period___stVal__path_name) (<https://github.com/magbak/quarry-rs#nestAggregation>(?valve_PosPct___Period___mag__path_name) AS ?valve_PosPct___Period___mag__path_name) (<https://github.com/magbak/quarry-rs#nestAggregation>(?valve__Dash___Mvm___Period___stVal__timeseries_datapoint_value) AS ?valve__Dash___Mvm___Period___stVal__timeseries_datapoint_value) (<https://github.com/magbak/quarry-rs#nestAggregation>(?valve_PosPct___Period___mag__timeseries_datapoint_value) AS ?valve_PosPct___Period___mag__timeseries_datapoint_value) ?valve_path_name ?timestamp WHERE { {SELECT (AVG(?valve__Dash___Mvm___Period___stVal__timeseries_datapoint_value) AS ?valve__Dash___Mvm___Period___stVal__timeseries_datapoint_value) (AVG(?valve_PosPct___Period___mag__timeseries_datapoint_value) AS ?valve_PosPct___Period___mag__timeseries_datapoint_value) ?valve__Dash___Mvm___Period___stVal__path_name ?valve_PosPct___Period___mag__path_name ?timestamp_grouping WHERE { ?ABC <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?type_var_0 .?type_var_0 <http://example.org/types#hasName> "ABC" .?valve <http://example.org/types#hasName> "HLV" .?ABC <http://example.org/types#hasOneDashRelation> ?valve .?valve__Dash___Mvm_ <http://example.org/types#hasName> "Mvm" .?valve <http://example.org/types#hasOnePeriodRelation> ?valve__Dash___Mvm_ .?valve__Dash___Mvm___Period___stVal_ <http://example.org/types#hasName> "stVal" .?valve__Dash___Mvm_ <http://example.org/types#hasOnePeriodRelation> ?valve__Dash___Mvm___Period___stVal_ .?valve__Dash___Mvm___Period___stVal_ <https://github.com/magbak/quarry-rs#hasTimeseries> ?valve__Dash___Mvm___Period___stVal__timeseries .?valve__Dash___Mvm___Period___stVal__timeseries <https://github.com/magbak/quarry-rs#hasTimeseries> ?valve__Dash___Mvm___Period___stVal__timeseries_datapoint .?valve__Dash___Mvm___Period___stVal__timeseries_datapoint <https://github.com/magbak/quarry-rs#hasValue> ?valve__Dash___Mvm___Period___stVal__timeseries_datapoint_value .?valve__Dash___Mvm___Period___stVal__timeseries <https://github.com/magbak/quarry-rs#hasTimestamp> ?timestamp .?ABC <http://example.org/types#hasName> ?ABC_name_on_path .?valve <http://example.org/types#hasName> ?valve_name_on_path .?valve__Dash___Mvm_ <http://example.org/types#hasName> ?valve__Dash___Mvm__name_on_path .?valve__Dash___Mvm___Period___stVal_ <http://example.org/types#hasName> ?valve__Dash___Mvm___Period___stVal__name_on_path .?valve_PosPct_ <http://example.org/types#hasName> "PosPct" .?valve <http://example.org/types#hasOnePeriodRelation> ?valve_PosPct_ .?valve_PosPct___Period___mag_ <http://example.org/types#hasName> "mag" .?valve_PosPct_ <http://example.org/types#hasOnePeriodRelation> ?valve_PosPct___Period___mag_ .?valve_PosPct___Period___mag_ <https://github.com/magbak/quarry-rs#hasTimeseries> ?valve_PosPct___Period___mag__timeseries .?valve_PosPct___Period___mag__timeseries <https://github.com/magbak/quarry-rs#hasTimeseries> ?valve_PosPct___Period___mag__timeseries_datapoint .?valve_PosPct___Period___mag__timeseries_datapoint <https://github.com/magbak/quarry-rs#hasValue> ?valve_PosPct___Period___mag__timeseries_datapoint_value .?valve_PosPct___Period___mag__timeseries <https://github.com/magbak/quarry-rs#hasTimestamp> ?timestamp .?valve <http://example.org/types#hasName> ?valve_name_on_path .?valve_PosPct_ <http://example.org/types#hasName> ?valve_PosPct__name_on_path .?valve_PosPct___Period___mag_ <http://example.org/types#hasName> ?valve_PosPct___Period___mag__name_on_path . FILTER((("2021-11-30T23:00:01+00:00"^^<http://www.w3.org/2001/XMLSchema#dateTime> >= ?timestamp) && ("2021-12-01T23:00:01+00:00"^^<http://www.w3.org/2001/XMLSchema#dateTime> <= ?timestamp))) BIND(CONCAT(?ABC_name_on_path, "-", ?valve_name_on_path, ".", ?valve__Dash___Mvm__name_on_path, ".", ?valve__Dash___Mvm___Period___stVal__name_on_path) AS ?valve__Dash___Mvm___Period___stVal__path_name) BIND(CONCAT(?valve_name_on_path, ".", ?valve_PosPct__name_on_path, ".", ?valve_PosPct___Period___mag__name_on_path) AS ?valve_PosPct___Period___mag__path_name) BIND(FLOOR(<https://github.com/magbak/quarry-rs#DateTimeAsSeconds>(?timestamp) / "600"^^<http://www.w3.org/2001/XMLSchema#unsignedLong>) AS ?timestamp_grouping) } GROUP BY ?valve__Dash___Mvm___Period___stVal__path_name ?valve_PosPct___Period___mag__path_name ?timestamp_grouping} BIND(<https://github.com/magbak/quarry-rs#SecondsAsDateTime>(?timestamp_grouping) AS ?timestamp) BIND(CONCAT(?ABC, "-", ?valve, ".", ?valve__Dash___Mvm_, ".", ?valve__Dash___Mvm___Period___stVal_) AS ?valve_path_name) } GROUP BY ?valve_path_name ?timestamp} }"#.to_string();
    assert_eq!(expected_query_str, actual_str);
}
...
"#;
    ...
    let actual = translator.translate(&tsq);
    //println!("{}", actual);
    let expected_query_str = r#"SELECT ?stval_path_name ?valve_PosPct___Period___mag__path_name ?stval_timeseries_datapoint_value ?valve_PosPct___Period___mag__timeseries_datapoint_value ?timestamp WHERE { {SELECT (SAMPLE(?stval_path_name) AS ?stval_path_name) (<https://github.com/magbak/quarry-rs#nestAggregation>(?valve_PosPct___Period___mag__path_name) AS ?valve_PosPct___Period___mag__path_name) (SAMPLE(?stval_timeseries_datapoint_value) AS ?stval_timeseries_datapoint_value) (<https://github.com/magbak/quarry-rs#nestAggregation>(?valve_PosPct___Period___mag__timeseries_datapoint_value) AS ?valve_PosPct___Period___mag__timeseries_datapoint_value) ?stval_path_name ?timestamp WHERE { ?ABC <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?type_var_0 .?type_var_0 <http://example.org/types#hasName> "ABC" .?valve <http://example.org/types#hasName> "HLV" .?ABC <http://example.org/types#hasOneDashRelation> ?valve .?valve__Dash___Mvm_ <http://example.org/types#hasName> "Mvm" .?valve <http://example.org/types#hasOnePeriodRelation> ?valve__Dash___Mvm_ .?stval <http://example.org/types#hasName> "stVal" .?valve__Dash___Mvm_ <http://example.org/types#hasOnePeriodRelation> ?stval .?stval <https://github.com/magbak/quarry-rs#hasTimeseries> ?stval_timeseries .?stval_timeseries <https://github.com/magbak/quarry-rs#hasTimeseries> ?stval_timeseries_datapoint .?stval_timeseries_datapoint <https://github.com/magbak/quarry-rs#hasValue> ?stval_timeseries_datapoint_value .?stval_timeseries <https://github.com/magbak/quarry-rs#hasTimestamp> ?timestamp .?ABC <http://example.org/types#hasName> ?ABC_name_on_path .?valve <http://example.org/types#hasName> ?valve_name_on_path .?valve__Dash___Mvm_ <http://example.org/types#hasName> ?valve__Dash___Mvm__name_on_path .?stval <http://example.org/types#hasName> ?stval_name_on_path .?valve_PosPct_ <http://example.org/types#hasName> "PosPct" .?valve <http://example.org/types#hasOnePeriodRelation> ?valve_PosPct_ .?valve_PosPct___Period___mag_ <http://example.org/types#hasName> "mag" .?valve_PosPct_ <http://example.org/types#hasOnePeriodRelation> ?valve_PosPct___Period___mag_ .?valve_PosPct___Period___mag_ <https://github.com/magbak/quarry-rs#hasTimeseries> ?valve_PosPct___Period___mag__timeseries .?valve_PosPct___Period___mag__timeseries <https://github.com/magbak/quarry-rs#hasTimeseries> ?valve_PosPct___Period___mag__timeseries_datapoint .?valve_PosPct___Period___mag__timeseries_datapoint <https://github.com/magbak/quarry-rs#hasValue> ?valve_PosPct___Period___mag__timeseries_datapoint_value .?valve_PosPct___Period___mag__timeseries <https://github.com/magbak/quarry-rs#hasTimestamp> ?timestamp .?valve <http://example.org/types#hasName> ?valve_name_on_path .?valve_PosPct_ <http://example.org/types#hasName> ?valve_PosPct__name_on_path .?valve_PosPct___Period___mag_ <http://example.org/types#hasName> ?valve_PosPct___Period___mag__name_on_path . FILTER((("2021-11-30T23:00:01+00:00"^^<http://www.w3.org/2001/XMLSchema#dateTime> >= ?timestamp) && ("2021-12-01T23:00:01+00:00"^^<http://www.w3.org/2001/XMLSchema#dateTime> <= ?timestamp))) BIND(CONCAT(?ABC_name_on_path, "-", ?valve_name_on_path, ".", ?valve__Dash___Mvm__name_on_path, ".", ?stval_name_on_path) AS ?stval_path_name) BIND(CONCAT(?valve_name_on_path, ".", ?valve_PosPct__name_on_path, ".", ?valve_PosPct___Period___mag__name_on_path) AS ?valve_PosPct___Period___mag__path_name) } GROUP BY ?stval_path_name ?timestamp} }"#.to_string();
    assert_eq!(expected_query_str, actual.to_string());
}