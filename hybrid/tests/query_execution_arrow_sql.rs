...
//     };
//     let config = Config {
//         image: Some(DREMIO_SERVER_IMAGE),
//         cmd: None,
//         exposed_ports: Some(HashMap::from([("9047/tcp", HashMap::new()), ("32010/tcp", HashMap::new()), ("7878/tcp", HashMap::new())])),
//         host_config: Some(HostConfig {
//             port_bindings: Some(HashMap::from([(
//                 "9047/tcp".to_string(),
//                 Some(vec![PortBinding {
...
//
// #[fixture]
// async fn with_timeseries_testdata(testdata_path: PathBuf) -> InMemoryTimeseriesDatabase {
//     let ts_table = "my_timeseries_table";
//     let value_column = vec!["my_value"];
//     let timestamp_column = "my_timestamp";
//     let identifier_column= "my_id";
//     let mut sql_db = ArrowFlightSQLDatabase::new("0.0.0.0:32010", ts_table, value_column, timestamp_column, identifier_column).await.unwrap();
//     sql_db.execute_sql_query(format!("CREATE TABLE {} ({} VARCHAR(255), {} INT, {} DATETMIE)",ts_table, identifier_column, value_column)
//
//     for t in ["ts1", "ts2"] {
